...
if __name__ == "__main__":
    ...
    mlflow.set_tracking_uri("./mytracking")
    exp_id = mlflow.create_experiment(name="myexperiment1", artifact_location="./myartifacts",
                                   tags={"version": "v1.0"})

    # retrieve artifacts
    get_exp = mlflow.get_experiment(exp_id)
    print("Name of artifact: {}".format(get_exp.name))
    print("Experiment ID: {}".format(get_exp.experiment_id))
    print("Experiment location: {}".format(get_exp.artifact_location))
    print("Tags: {}".format(get_exp.tags))
    print("Lifecycle stage: {}".format(get_exp.lifecycle_stage))
    print("Timestamp: {}".format(get_exp.creation_time))
    ...
    print(f"Retrieve tracking uri: {mlflow.get_tracking_uri()}")
